...
//        this.sup=sup;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        float gia=Float.parseFloat(jTextField3.getText());
        String thuonghieu=jTextField4.getText();
        String xuatxu=jTextField5.getText();
        int soluong=Integer.parseInt(jTextField6.getText());
        Product pro=new Product(ma, ten, gia, thuonghieu, xuatxu, soluong);
        ProductDAO dao=new ProductDAO();
        dao.addProduct(pro);
